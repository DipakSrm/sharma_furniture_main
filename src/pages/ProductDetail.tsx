...
const ProductDetail = () => {
    ...
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_LOCAL_URI || import.meta.env.VITE_API_URI}/products/${id}`
        );
  ...
  const fetchRelatedProductDetails = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_LOCAL_URI || import.meta.env.VITE_API_URI}/products/search?subcategory=${encodeURIComponent(
